 ...
 * Use the [DayFragmentNight.newInstance] factory method to
 * create an instance of this fragment.
 */
class DayFragmentNight : Fragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_day_night, container, false)
    }
    ...
    override fun onStart() {
        ...
        try{
            ...
            val back_to_person = view?.findViewById<ImageButton>(R.id.back_to_person_night)
            val next_to_price = view?.findViewById<ImageButton>(R.id.next_to_price_night)
            back_to_person?.setOnClickListener{ view : View ->
                view.findNavController().popBackStack()
            }
            next_to_price?.setOnClickListener{ view : View ->
                view.findNavController().navigate(R.id.action_dayFragmentNight_to_priceFragmentNight)
            }
    ...
    companion object {
         ...
         * @return A new instance of fragment DayFragmentNight.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            DayFragmentNight().apply {
