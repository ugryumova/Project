 ...
 * Use the [FinalFragmentNight.newInstance] factory method to
 * create an instance of this fragment.
 */
class FinalFragmentNight : Fragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_final_night, container, false)
    }
    ...
    override fun onStart() {
        ...
        val from3 = view?.findViewById<TextView>(R.id.from6)
        val to3 = view?.findViewById<TextView>(R.id.to6)
        ...
        val back_to_prod = view?.findViewById<ImageButton>(R.id.back_to_prod_night)
        try{
    ...
    companion object {
         ...
         * @return A new instance of fragment FinalFragmentNight.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            FinalFragmentNight().apply {
