...
class InterestFragment : Fragment() {
    ...
    override fun onStart() {
        ...
        val back_to_price = view?.findViewById<ImageButton>(R.id.back_to_price)
        val next_to_product = view?.findViewById<ImageButton>(R.id.next_to_product)
        ...
        next_to_product?.setOnClickListener{ view : View ->
            ...
            view.findNavController().navigate(R.id.action_interestFragment_to_productFragment, bundle)
